"""
Django settings for the AI Telephony Assistant project.
"""
...
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    "rimosely-unprecipitated-gaynell.ngrok-free.dev",
]
...
DATABASE_URL="postgresql://telephony_user:password123@localhost:5432/telephony_ai"
DATABASES = {
    'default': {
